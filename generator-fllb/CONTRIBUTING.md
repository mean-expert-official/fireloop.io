...
Thank you for your interest in `generator-loopback`, an open source project
administered by StrongLoop.

Contributing to `generator-loopback` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/generator-loopback)
