...
module.exports = generators.Base.extend({
    ...
    copyTemplates: function () {
        ...
        if (this.options.current) {
            [
                {
                    template: 'templates/app.module.ionic.ts',
                    output: this.options.current + "/src/app/app.module.ts",
                    params: {}
                },
                {
                    template: 'templates/tsconfig.ionic.tpl',
...
//# sourceMappingURL=/Volumes/HD710M/development/www/mean.expert/@mean-expert/generator-fireloop/src/ionic/index.js.map
