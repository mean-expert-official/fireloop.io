    ...
    if (o.extend = function (e, t) {
        ...
        var c, u, p = e.JSON, h = e.location, f = e.XMLHttpRequest, m = p && p.stringify && e.localStorage, v = e.navigator.userAgent, g = "https:" == t.location.protocol ? "https:" : "http:", b = 0, y = [], _ = u = function () {
            ...
            , C = function (e) {
                ...
                fullTime: function (e) {
                    var t = S.parseDate(e);
                    return t.getFullYear() + "year" + (t.getMonth() + 1) + "month" + t.getDate() + "day " + t.toLocaleTimeString()
                },
                elapsedTime: function (e) {
                    var t = S.parseDate(e)
                        , s = new Date
                        , a = (s - b - t) / 1e3;
                    return 10 > a ? "about" : 60 > a ? Math.round(a) + "Seconds ago" : 3600 > a ? Math.round(a / 60) + "minutes ago" : 86400 > a ? Math.round(a / 3600) + "An hour ago" : (s.getFullYear() == t.getFullYear() ? "" : t.getFullYear() + "year") + (t.getMonth() + 1) + "month" + t.getDate() + "day"
                },
        ...
        var M = {
            ...
            , z = {
                ...
                no_comments_yet: "There is no comment, so you grab the sofa",
                repost_reason: "Please enter a reason for forwarding",
                hot_posts_title: "Top up comments",
                comments_zero: "no comment yet",
                comments_one: "1 comment",
                comments_multiple: "{num}comment",
                reposts_zero: "No forwarding",
                reposts_one: "1Article Forwarding",
                reposts_multiple: "{num}Article Forwarding",
                weibo_reposts_zero: "No Sina microblogging",
                weibo_reposts_one: "1 Sina microblogging",
                weibo_reposts_multiple: "{num} Sina microblogging",
                qqt_reposts_zero: "No Tencent microblogging",
                qqt_reposts_one: "1 Tencent microblogging",
                qqt_reposts_multiple: "{num}Tencent microblogging"
            }
            , D = {
                get: function (e) {
                    return m ? m[e] : void 0
        ...
        var J = S.Event = H.extend({
            ...
            , Q = S.Widget = J.extend({
                ...
                onMessage: function () { },
                onError: function (e) {
                    C.error("Error friends(" + e.code + "): " + e.errorMessage),
                        e.errorTrace && C.error(e.errorTrace)
                }
            })
            , V = S.Model = J.extend({
        ...
        et.commentList = function (e) {
            ...
            et["dialog-anonymous"] = function (e) {
                ...
                return t += "</div>",
                    e.options.deny_anonymous || (t += '<h2>As a guest message</h2><form><div class="ds-control-group"><input type="text" name="author_name" id="ds-dialog-name" value="' + u(nt.data.name) + '" required /><label for="ds-dialog-name">名字(必填)</label></div>',
            ...
            et["dialog-bind-more"] = function () {
                var e = '<h2>Bind more accounts</h2><ul class="ds-service-list">' + et.serviceBindList(X) + '</ul><ul class="ds-service-list ds-additional-services">' + et.serviceBindList(K) + '</ul><div style="clear:both"></div>';
                return e
            }
            ,
            et["dialog-qrcode"] = function (e) {
                var t = '<h2>WeChat sweep sweep, to share a circle of friends</h2><div class="ds-share-qrcode" style="text-align:center;"><img src="' + e.qrcode_url + '" alt="' + e.url + '"></div>';
                return t
            }
            ,
            et["dialog-reposts"] = function (e) {
                var t = '<h2>Forward to microblogging</h2><div class="ds-quote"><strong>@' + u(e.post.theAuthor.name) + "</strong>: " + e.post.message + "</div><form>" + tt({
                    post_id: e.post.post_id
                }) + '<div class="ds-textarea-wrapper"><textarea name="message" title="Ctrl+Enter Shortcut submission" placeholder="' + u(z.repost_reason) + '">' + u(e.repostMessage) + '</textarea><pre class="ds-hidden-text"></pre>';
                return t += '</div><div class="ds-actions">',
                    e.service ? t += tt({
                        ...
                        t += ' /><span class="ds-service-icon ds-weibo"></span>Sina Weibo</label><label><input type="checkbox" name="service[]" value="qqt"',
                        nt.data.social_uid.qq && (t += ' checked="checked"'),
                        t += ' /><span class="ds-service-icon ds-qqt"></span>Tencent Weibo</label>'),
                    t += '<button type="submit">' + z.repost + "</button></div></form>"
            }
            ,
            et.dialog = function (e) {
                var t = '<div class="ds-dialog"><div class="ds-dialog-inner ds-rounded"><div class="ds-dialog-body">' + e + '</div><div class="ds-dialog-footer"><a href="http://duoshuo.com/" target="_blank" class="ds-logo"></a><span>Social comment box</span></div><a class="ds-dialog-close" href="javascript:void(0)" title="shut down"><i class="icon icon-times"></i></a></div></div>';
                return t
            }
            ,
            ...
            et.likeTooltip = function (e) {
                var t = '<div class="ds-like-tooltip ds-rounded"><p>I am glad you can like to share it:</p><ul>';
            ...
            et.loginButtons = function () {
                var e = '<div class="ds-login-buttons"><p>Social account login:</p><div class="ds-social-links"><ul class="ds-service-list">' + et.serviceList(X) + '<li><a class="ds-more-services" href="javascript:void(0)">More"</a></li></ul><ul class="ds-service-list ds-additional-services">' + et.serviceList(K) + "</ul></div></div>";
                return e
            }
            ,
            ...
            et.meta = function (e) {
                ...
                return e.user_vote > 0 && (t += " ds-thread-liked"),
                    ...
                    t += e.user_vote > 0 ? "Have liked" : "like",
                    t += '</span><span class="ds-thread-cancel-like">cancel like</span></a><span class="ds-like-panel"></span></div>'
            }
            ,
            et.notify = function (e) {
                ...
                return e.comments || (t += ' style="display:none;"'),
                    t += '><a data-type="unread-comments" href="javascript:void(0);">you have' + e.comments + "New reply</a></li><li",
                    e.notifications || (t += ' style="display:none;"'),
                    t += '><a data-type="unread-notifications" href="javascript:void(0);">you have' + e.notifications + "System messages</a></li></ul></div>"
            }
            ,
            et.post = function (e) {
                var t = ""
                ...
                if (t += '<li class="ds-post" data-post-id="' + s.post_id + '"><div class="ds-post-self" data-post-id="' + s.post_id + '" data-thread-id="' + s.thread_id + '" data-root-id="' + s.root_id + '" data-source="' + s.source + '"><div class="ds-avatar"',
                    ...
                    if (n)
                        for (var o, d = -1, l = n.length - 1; l > d;)
                            o = n[d += 1],
                                1 == d && s.parents.length > 2 && (t += '<li class="ds-ctx-entry"><a href="javascript:void(0);" class="ds-expand">还有' + (s.parents.length - 2) + "Comments</a></li>"),
                                t += et.ctxPost({
                                    post: o,
                                    index: d,
            ...
            et["related-read"] = function (e) {
                var t = "";
                if (e && e.length) {
                    t += '<article class="ds-reads-expand"><div class="ds-header">Headlines recommended</div><section> ';
                    var s = e;
                    if (s)
                        for (var a, i = -1, r = s.length - 1; r > i;) {
                            if (a = s[i += 1],
                                ...
                                t += ' </ul> </div> <div class="ds-reads-info"> ',
                                    1 == a.type && (t += ' <span class="ds-reads-app-special">Open the headline reading</span> '),
            ...
            et.replybox = function (e) {
                ...
                if (t += r() ? ' href="javascript:void(0);" onclick="return false"' : ' href="' + S.REMOTE + "/settings/avatar/" + x(T()) + '" target="_blank" title="Set Avatar"',
                    t += ">" + et.avatarImg(nt.data) + '</a><form method="post">' + tt(e.params) + '<div class="ds-textarea-wrapper ds-rounded-top"><textarea name="message" class="ds-rounded-top" title="Ctrl+Enter Shortcut submission" placeholder="' + u(z.leave_a_message) + '"></textarea><pre class="ds-hidden-text"></pre>',
                    t += "</div>",
                ...
                return t += "</span>",
                    ...
                    e.options.use_smilies && (t += '<a class="ds-toolbar-button ds-add-emote" title="Insert expression"><i class="icon icon-smile-o"></i></a>'),
                    e.options.use_images && e.options.parse_html_enabled && (t += '<a class="ds-toolbar-button ds-add-image" title="Insert a picture"><i class="icon icon-image"></i></a>'),
                    t += "</div></div>",
                    t += "</form></div>"
            }
            ,
            ...
            ,
            et.toolbar = function () {
                var e = '<div class="ds-toolbar"><div class="ds-account-control"><span><i class="icon icon-cog"></i>Account management</span><ul><li><a class="ds-bind-more" href="javascript:void(0);" style="border-top: none">Bind more</a></li><li><a target="_blank" href="' + S.REMOTE + "/settings/" + x(T()) + '">' + u(z.settings) + '</a></li><li><a rel="nofollow" href="' + Z.logoutUrl() + '" style="border-bottom: none">Sign out</a></li></ul></div><div class="ds-visitor">';
                return e += nt.data.url ? '<a class="ds-visitor-name" href="' + u(nt.data.url) + '" target="_blank">' + u(nt.data.name) + "</a>" : '<span class="ds-visitor-name">' + u(nt.data.name) + "</span>",
                    e += '<a class="ds-unread-comments-count" href="javascript:void(0);" title="New reply"></a></div></div>'
            }
            ,
        ...
        it.on("queryDefined", function () {
            ...
            S.require("embed.compat", function () {
                ...
                function x(e, t, s, a) {
                    function i() {
                        ...
                        return a || l.find("[type=checkbox]:checked")[0] ? (R.post("posts/repost", S.toJSON(l), e),
                            o.close(),
                            !1) : (alert("There is no election to publish it"),
                                !1)
                    }
                    function r() {
                        var e = this.value;
                ...
                function T(e) {
                    var t = {
                        "unread-comments": {
                            title: "New message and reply",
                            apiUrl: "users/unreadComments",
                            tmpl: function (e) {
                                return e.thread ? '<li data-thread-id="' + e.thread.thread_id + '">' + H.map(e.authors, et.userAnchor).join("、") + ' 在 <a class="ds-read" href="' + e.thread.url + '#comments" target="_blank">' + _(e.thread.title || "无标题") + '</a> 中回复了你 <a class="ds-delete ds-read" title="Got it" href="javascript:void(0)">Got it</a></li>' : ""
                            },
                            read: function (e) {
                        ...
                        "unread-notifications": {
                            ...
                            tmpl: function (e) {
                                return '<li data-notification-id="' + e.notification_id + '" data-notification-type="' + e.type + '">' + e.content + ' <a class="ds-delete ds-read" title="Got it" href="javascript:void(0)">Got it</a></li>'
                            },
                            read: function (e) {
                        ...
                        function t() {
                            ...
                            try {
                                if (a.hasClass("ds-comment-context"))
                                    ...
                                    }) + '</ul><div class="ds-bubble-footer"><a class="ds-ctx-open" href="javascript:void(0);">View the conversation</a></div>');
                ...
                e.postMessage && (e.addEventListener ? e.addEventListener("message", g, !1) : e.attachEvent && e.attachEvent("onmessage", g)),
                        ...
                        render: function (e) {
                            ...
                            var g = i.el = H(et.replybox(h)).click(p)
                                ...
                                , x = (g.find(".ds-add-image").click(function (e) {
                                    var s = k[0]
                                        , a = s.value
                                        , i = "Please enter an image address"
                                        , r = '<img src="' + i + '" />';
                                    if (t.selection) {
                                    ...
                                    if (a.find(".ds-icons-32 a").click(l),
                                        ...
                                        i.submit(function () {
                                            ...
                                            return !e && !c.require_guest_email || e.match(/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/) ? (t(S.toJSON(i)),
                                                s.close(),
                                                !1) : (alert("Please enter a valid email address."),
                                                    !1)
                                        }),
                            ...
                            b.submit(function () {
                                ...
                                return "" == e || !P.placeholder && e == k.attr("placeholder") ? (alert("You have not written yet"),
                                    !1) : (r() ? T(b, q) : q(),
                                        !1)
                            });
                            var C = function (e) {
                    ...
                    et.likePanel = function (e) {
                        return e.likes ? '<span class="ds-highlight">' + e.likes + "</span> 人like" : ""
                    }
                    ,
                    st.Meta = function (e) {
                        this.embedThread = e
                        ...
                        render: function () {
                            function a(a) {
                                ...
                                if (R.post("threads/vote", {
                                    ...
                                    l.find(".ds-thread-like-text").text(p ? "like" : "Have liked"),
                                    p)
                ...
                var X = H('<div id="ds-bubble"><div class="ds-bubble-content"></div><div class="ds-arrow ds-arrow-down ds-arrow-border"></div><div class="ds-arrow ds-arrow-down"></div></div>')
                    , K = X.find(".ds-bubble-content").delegate("a.ds-ctx-open", "click", function () {
                        ...
                        var s = E('<h2>View the conversation</h2><ol id="ds-ctx"></ol>');
                ...
                X.mouseenter(N).mouseleave(I),
                    ...
                    st.EmbedThread = Q.extend({
                        ...
                        render: function () {
                            var e = this.el;
                            if ("Please replace this article with the ID of the article in your site" === e.data("thread-key"))
                                return alert("Please set the correct data-thread-key 属性"),
                                    !1;
                        ...
                        updateCounter: function (e) {
                            ...
                            var s = {
                                ...
                                weibo: ["weibo_reposts", t(z.weibo_reposts_multiple) || "Sina Weibo"],
                                qqt: ["qqt_reposts", t(z.qqt_reposts_multiple) || "Tencent Weibo"]
                            };
                            for (var a in s)
                                if (!e || e == a) {
                        ...
                        onError: function (e) {
                            this.el.html("Comment box wrong friends(" + e.code + "): " + e.errorMessage)
                        },
                        onload: function (t) {
                            var a = this
                            ...
                            "top" == o.formPosition && H.fn.append.apply(d, u),
                                ...
                                ot.on("reset", function () {
                                    ...
                                    d.find("a.ds-unread-comments-count").html(e).attr("title", e ? "you have" + e + "New reply" : "你没有新回复").css("display", e ? "inline" : "none")
                                }),
                ...
                S.initSelector = function (e, t) {
                    ...
                    H(function () {
                        if (!c) {
                            if (!q())
                                return C.error("The definition of duoshuoQuery is missing");
                            C.warn("Please define duoshuoQuery before loading embed.js")
                        }
